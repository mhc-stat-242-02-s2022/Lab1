...
Your goal is to get some practice working with data sets in R.  The idea is to take the example code provided in the notes for analyzing the mean body temperature and adapt it for analyzing the mean difference in the volumes of the left hippocampus between the twins who are unaffected and affected by schizophrenia.
